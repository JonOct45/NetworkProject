...
class CDMA_Protocol:
    ...
    """
    Generate a set of N codes where N is the number of different users.
    """
    ...
    """
    Encode data using CDMA protocol with specified code.
    """
    ...
    """
    Encode a message using CDMA protocol with the set of codes.
    """
    ...
    def decode(self, frequency: list, code: list) -> list:
        ...
        for i in range(len(frequency) // code_len):    
            ...
            # print(f'decode set: {decode}\tresult: {result}')
