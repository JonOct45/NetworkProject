...
This project is worth 40% of your final grade, and will be graded using a point scale where the 
maximum possible grade is 40 points. In addition, this project will be graded using two checkpoints. 

    * Checkpoint #1 (due the week before spring break) 
           
          1. If your server and client files run without errors or crashes, the first client is not blocking the main thread, it 
             prints the menu. then + 7 points. 
          2. Options 1, 2, 3, 4, and 5 from the menu will be graded by the deadline of this checkpoint.
          3. Each option implemented correctly from the menu will be awarded with +3 points
          4. The maximum grade a student can get in this checkpoint is 22 points.
    
    * Checkpoint #2 (due the day of the final exam)
          
          1. Options 6, 7, 8, 9, 10, and 11 from the menu will be graded by the deadline of this checkpoint. 
          2. Each option implemented correctly from the menu will be awarded with +3 points
          3. 4. The maximum grade a student can get in this checkpoint is 18 points.
          
    * IMPORTANT: partial credit for options not correctly implemented will be given at my discretion, and it will depends on the ammount           
                 of work the students have put on the assignment.  
    
    
    * The proxy server option (extra-credit) is 5% that will be added to your final grade at the end of the semester. This
...
***IMPORTANT: you'll be given enough time to complete each checkpoint, and therefore, there won't be extensions granted for this project***

# Project Submission

Once every checkpoint for this project is completed, set the checkpoint to "completed" in the table of assignments located on the main README file of this repository.
