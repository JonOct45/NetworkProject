...
class Client(object):
    ...
    def connect(self, server_ip_address, server_port):
        ...
        """
        #Assigning the Server IP / Server Port
        ...
        if data: 
            print("{} has successfully connect to {}/{}".format(data,server_ip_address,server_port))
    ...
    def client_helper(self):
        ...
        """
        #Creating the client helper and starting the clienthelper
